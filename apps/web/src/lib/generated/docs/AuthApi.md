...
| [**apiV1MeAddressesAddressIdPatch**](AuthApi.md#apiv1meaddressesaddressidpatchoperation) | **PATCH** /api/v1/me/addresses/{addressId} | Update a saved address |
| [**apiV1MeAddressesGet**](AuthApi.md#apiv1meaddressesget) | **GET** /api/v1/me/addresses | List saved addresses |
| [**apiV1MeAddressesPost**](AuthApi.md#apiv1meaddressespostoperation) | **POST** /api/v1/me/addresses | Create a saved address |
...
import type { ApiV1MeAddressesAddressIdDeleteRequest } from '';
...
async function example() {
  ...
  } satisfies ApiV1MeAddressesAddressIdDeleteRequest;

  try {
    const data = await api.apiV1MeAddressesAddressIdDelete(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **addressId** | `string` | Address identifier | [Defaults to `undefined`] |
...
import type { ApiV1MeAddressesAddressIdPatchOperationRequest } from '';
...
async function example() {
  ...
  const body = {
    ...
    apiV1MeAddressesAddressIdPatchRequest: ...,
  } satisfies ApiV1MeAddressesAddressIdPatchOperationRequest;

  try {
    const data = await api.apiV1MeAddressesAddressIdPatch(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { ApiV1MeAddressesGetRequest } from '';
...
async function example() {
  ...
  try {
    const data = await api.apiV1MeAddressesGet();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { ApiV1MeAddressesPostOperationRequest } from '';
...
async function example() {
  ...
  const body = {
    ...
    apiV1MeAddressesPostRequest: ...,
  } satisfies ApiV1MeAddressesPostOperationRequest;

  try {
    const data = await api.apiV1MeAddressesPost(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { ApiV1MeDeleteRequest } from '';
...
async function example() {
  ...
  try {
    const data = await api.apiV1MeDelete();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
