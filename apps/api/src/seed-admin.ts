...
const DEFAULT_SETTINGS = [
  ...
  { group: "settlements", key: "merchant_payout_minimum_xof",  value: "200",                         description: "Minimum de versement marchand (XOF)" },
  { group: "settlements", key: "merchant_payout_cadence",      value: "immediate",                   description: "Cadence de versement marchand" },
  { group: "settlements", key: "merchant_payout_release_hour_utc", value: "21",                      description: "Heure UTC de déclenchement des versements batchés" },
  { group: "settlements", key: "merchant_payout_weekly_day",   value: "friday",                      description: "Jour principal des versements hebdomadaires" },
  { group: "settlements", key: "merchant_payout_second_weekly_day", value: "tuesday",                description: "Second jour des versements bihebdomadaires" },
