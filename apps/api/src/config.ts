...
export const config = {
  ...
  intechApiKey: process.env.INTECH_API_KEY ?? process.env.PAYTECH_API_KEY ?? "",
  intechApiSecret: process.env.INTECH_API_SECRET ?? process.env.PAYTECH_API_SECRET ?? "",
  intechEnv: (process.env.INTECH_ENV as "test" | "prod") ?? ((process.env.PAYTECH_ENV as "test" | "prod") ?? "test"),
