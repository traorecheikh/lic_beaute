...
import { PrismaClient, Role, SalonApprovalStatus, SubscriptionTier, SubscriptionStatus, PaymentProvider, BlockedSlotScope } from "../src/generated/prisma/client.ts";
...
async function main() {
  ...
  const platformSettings = [
    ...
    { group: "payment_methods", key: "paydunya_enabled_expresso_senegal", value: "true", description: "Expresso Sénégal activé" },
