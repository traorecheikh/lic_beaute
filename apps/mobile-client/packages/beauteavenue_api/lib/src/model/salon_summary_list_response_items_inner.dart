...
/// * [distanceKm]
@BuiltValue()
abstract class SalonSummaryListResponseItemsInner
    implements
        Built<SalonSummaryListResponseItemsInner,
  ...
  factory SalonSummaryListResponseItemsInner(
          [void updates(SalonSummaryListResponseItemsInnerBuilder b)]) =
      _$SalonSummaryListResponseItemsInner;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SalonSummaryListResponseItemsInnerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SalonSummaryListResponseItemsInner> get serializer =>
      _$SalonSummaryListResponseItemsInnerSerializer();
}

class _$SalonSummaryListResponseItemsInnerSerializer
    implements PrimitiveSerializer<SalonSummaryListResponseItemsInner> {
  @override
...
class SalonSummaryListResponseItemsInnerSubscriptionTierEnum extends EnumClass {
  ...
  static const SalonSummaryListResponseItemsInnerSubscriptionTierEnum standard =
      _$salonSummaryListResponseItemsInnerSubscriptionTierEnum_standard;
  @BuiltValueEnumConst(wireName: r'premium')
  static const SalonSummaryListResponseItemsInnerSubscriptionTierEnum premium =
      _$salonSummaryListResponseItemsInnerSubscriptionTierEnum_premium;

  static Serializer<SalonSummaryListResponseItemsInnerSubscriptionTierEnum>
      get serializer =>
          _$salonSummaryListResponseItemsInnerSubscriptionTierEnumSerializer;

  const SalonSummaryListResponseItemsInnerSubscriptionTierEnum._(String name)
      : super(name);

  static BuiltSet<SalonSummaryListResponseItemsInnerSubscriptionTierEnum>
      get values =>
          _$salonSummaryListResponseItemsInnerSubscriptionTierEnumValues;
  static SalonSummaryListResponseItemsInnerSubscriptionTierEnum valueOf(
          String name) =>
      _$salonSummaryListResponseItemsInnerSubscriptionTierEnumValueOf(name);
}
