...
class _$RegisterInputSerializer implements PrimitiveSerializer<RegisterInput> {
  ...
  RegisterInput deserialize(
    ...
    Object? anyOfDataSrc;
    final targetType = const FullType(AnyOf, [FullType(RegisterInputAnyOf), FullType(RegisterInputAnyOf1), ]);
...
class RegisterInputTypeEnum extends EnumClass {
  ...
  static const RegisterInputTypeEnum salonOwner = _$registerInputTypeEnum_salonOwner;

  static Serializer<RegisterInputTypeEnum> get serializer => _$registerInputTypeEnumSerializer;
