...
import 'package:beauteavenue_api/src/model/admin_audit_filters.dart';
import 'package:beauteavenue_api/src/model/admin_audit_summary.dart';
...
Serializers serializers = (_$serializers.toBuilder()
      ..addBuilderFactory(
        ...
        () => ListBuilder<ProSalonHour>(),
      )
      ..addBuilderFactory(
        const FullType(BuiltList, [FullType(ProPayoutEvent)]),
        () => ListBuilder<ProPayoutEvent>(),
      )
      ..addBuilderFactory(
        const FullType(BuiltList, [FullType(ProClientSummary)]),
        () => ListBuilder<ProClientSummary>(),
      )
      ..addBuilderFactory(
        const FullType(BuiltList, [FullType(ProInvoice)]),
      ...
      ..addBuilderFactory(
        ...
        () => ListBuilder<ProStaffMember>(),
      )
      ..addBuilderFactory(
        const FullType(BuiltList, [FullType(ProBookingDetail)]),
        () => ListBuilder<ProBookingDetail>(),
      )
      ..addBuilderFactory(
        const FullType(BuiltList, [FullType(ProService)]),
