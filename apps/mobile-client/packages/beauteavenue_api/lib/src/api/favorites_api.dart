...
class FavoritesApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [FavoriteListResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FavoriteListResponse>> apiV1FavoritesGet({ 
    ...
    final _path = r'/api/v1/favorites';
    ...
    FavoriteListResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(FavoriteListResponse),
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DeletedResponse>> apiV1FavoritesSalonIdDelete({ 
    ...
    final _path = r'/api/v1/favorites/{salonId}'.replaceAll('{' r'salonId' '}', encodeQueryParameter(_serializers, salonId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [FavoriteItem] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FavoriteItem>> apiV1FavoritesSalonIdPost({ 
    required String salonId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
