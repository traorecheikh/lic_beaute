...
class SalonsApi {
  ...
  Future<Response<SalonSummaryListResponse>> apiV1SalonsGet({
    ...
    SalonSummaryListResponse? _responseData;
    ...
    return Response<SalonSummaryListResponse>(
      data: _responseData,
