...
import 'package:beauteavenue_api/src/model/pro_blocked_slot_create_input.dart';
import 'package:beauteavenue_api/src/model/pro_booking_detail.dart';
import 'package:beauteavenue_api/src/model/pro_booking_full_detail.dart';
import 'package:beauteavenue_api/src/model/pro_booking_status_update.dart';
...
import 'package:beauteavenue_api/src/model/pro_invoice.dart';
import 'package:beauteavenue_api/src/model/pro_manual_booking_created.dart';
import 'package:beauteavenue_api/src/model/pro_manual_booking_input.dart';
import 'package:beauteavenue_api/src/model/pro_payout_event.dart';
import 'package:beauteavenue_api/src/model/pro_review.dart';
import 'package:beauteavenue_api/src/model/pro_review_response_input.dart';
import 'package:beauteavenue_api/src/model/pro_salon_hour.dart';
import 'package:beauteavenue_api/src/model/pro_salon_profile.dart';
import 'package:beauteavenue_api/src/model/pro_salon_profile_hours_inner.dart';
import 'package:beauteavenue_api/src/model/pro_salon_update_input.dart';
import 'package:beauteavenue_api/src/model/pro_service.dart';
import 'package:beauteavenue_api/src/model/pro_service_create_input.dart';
import 'package:beauteavenue_api/src/model/pro_service_update_input.dart';
import 'package:beauteavenue_api/src/model/pro_staff_create_input.dart';
import 'package:beauteavenue_api/src/model/pro_staff_member.dart';
import 'package:beauteavenue_api/src/model/pro_staff_update_input.dart';
import 'package:beauteavenue_api/src/model/pro_subscription.dart';
...
class ProApi {
  ...
  Future<Response<ProAnalytics>> apiV1ProAnalyticsGet({ 
    ...
    final _path = r'/api/v1/pro/analytics';
  ...
  Future<Response<BuiltList<ProBlockedSlot>>> apiV1ProBlockedSlotsGet({ 
    ...
    final _path = r'/api/v1/pro/blocked-slots';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<ProBlockedSlot>? _responseData;
    ...
    return Response<BuiltList<ProBlockedSlot>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ProBlockedSlot>> apiV1ProBlockedSlotsPost({ 
    ...
    return Response<ProBlockedSlot>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ProBookingStatusUpdate>> apiV1ProBookingsBookingIdAcceptPost({ 
    ...
    ProBookingStatusUpdate? _responseData;
    ...
    return Response<ProBookingStatusUpdate>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ProBookingFullDetail>> apiV1ProBookingsBookingIdGet({ 
    ...
    ProBookingFullDetail? _responseData;
    ...
    return Response<ProBookingFullDetail>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<ProBookingDetail>>> apiV1ProBookingsGet({ 
    ...
    final _path = r'/api/v1/pro/bookings';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<ProBookingDetail>? _responseData;
    ...
    return Response<BuiltList<ProBookingDetail>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ProManualBookingCreated>> apiV1ProBookingsManualPost({ 
    ...
    final _path = r'/api/v1/pro/bookings/manual';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ProManualBookingCreated? _responseData;
    ...
    return Response<ProManualBookingCreated>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ProCheckoutCompleteResult>> apiV1ProCheckoutBookingIdCompletePost({ 
    ...
    ProCheckoutCompleteResult? _responseData;
    ...
    return Response<ProCheckoutCompleteResult>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ProCheckoutDetails>> apiV1ProCheckoutBookingIdGet({ 
    ...
    ProCheckoutDetails? _responseData;
    ...
    return Response<ProCheckoutDetails>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ProClientDetail>> apiV1ProClientsClientIdGet({ 
    ...
    return Response<ProClientDetail>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<ProClientSummary>>> apiV1ProClientsGet({ 
    ...
    final _path = r'/api/v1/pro/clients';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<ProClientSummary>? _responseData;
    ...
    return Response<BuiltList<ProClientSummary>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ProDashboard>> apiV1ProDashboardGet({ 
    ...
    final _path = r'/api/v1/pro/dashboard';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<ProSalonHour>>> apiV1ProHoursGet({ 
    ...
    final _path = r'/api/v1/pro/hours';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<ProSalonHour>? _responseData;
    ...
    return Response<BuiltList<ProSalonHour>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<ProInvoice>>> apiV1ProInvoicesGet({ 
    ...
    final _path = r'/api/v1/pro/invoices';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<ProInvoice>? _responseData;
    ...
    return Response<BuiltList<ProInvoice>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<ProPayoutEvent>>> apiV1ProPayoutsGet({ 
    ...
    final _path = r'/api/v1/pro/payouts';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<ProPayoutEvent>? _responseData;
    ...
    return Response<BuiltList<ProPayoutEvent>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<ProReview>>> apiV1ProReviewsGet({ 
    ...
    final _path = r'/api/v1/pro/reviews';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<ProReview>? _responseData;
    ...
    return Response<BuiltList<ProReview>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ProSalonProfile>> apiV1ProSalonGet({ 
    ...
    final _path = r'/api/v1/pro/salon';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    return Response<ProSalonProfile>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<ProService>>> apiV1ProServicesGet({ 
    ...
    final _path = r'/api/v1/pro/services';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<ProService>? _responseData;
    ...
    return Response<BuiltList<ProService>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<ProStaffMember>>> apiV1ProStaffGet({ 
    ...
    final _path = r'/api/v1/pro/staff';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<ProStaffMember>? _responseData;
    ...
    return Response<BuiltList<ProStaffMember>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ProStaffMember>> apiV1ProStaffPost({ 
    ...
    return Response<ProStaffMember>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ProSubscriptionExecuteResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ProSubscriptionExecuteResponse>> apiV1ProSubscriptionChargeChargeIdExecutePost({ 
    required String chargeId,
    required ProSubscriptionExecuteInput proSubscriptionExecuteInput,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/pro/subscription/charge/{chargeId}/execute'.replaceAll('{' r'chargeId' '}', encodeQueryParameter(_serializers, chargeId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(ProSubscriptionExecuteInput);
      _bodyData = _serializers.serialize(proSubscriptionExecuteInput, specifiedType: _type);
    ...
    ProSubscriptionExecuteResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ProSubscriptionExecuteResponse),
      ) as ProSubscriptionExecuteResponse;
    ...
    return Response<ProSubscriptionExecuteResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ProSubscriptionCheckoutResult>> apiV1ProSubscriptionCheckoutPost({ 
    ...
    final _path = r'/api/v1/pro/subscription/checkout';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ProSubscriptionCheckoutResult? _responseData;
    ...
    return Response<ProSubscriptionCheckoutResult>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ProSubscription>> apiV1ProSubscriptionGet({ 
    ...
    final _path = r'/api/v1/pro/subscription';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    return Response<ProSubscription>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
