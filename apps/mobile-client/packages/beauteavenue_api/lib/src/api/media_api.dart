...
class MediaApi {
  ...
  ///
  /// Parameters:
  /// * [mediaId] - Media asset identifier
  ...
  Future<Response<ApiV1MediaMediaIdCompletePost200Response>> apiV1MediaMediaIdCompletePost({ 
    ...
    final _path = r'/api/v1/media/{mediaId}/complete'.replaceAll('{' r'mediaId' '}', encodeQueryParameter(_serializers, mediaId, const FullType(String)).toString());
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DeletedResponse>> apiV1MediaMediaIdDelete({ 
    required String mediaId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/media/{mediaId}'.replaceAll('{' r'mediaId' '}', encodeQueryParameter(_serializers, mediaId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [MediaAsset] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MediaAsset>> apiV1MediaMediaIdGet({ 
    required String mediaId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    MediaAsset? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(MediaAsset),
      ) as MediaAsset;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiV1MediaUploadIntentPost201Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiV1MediaUploadIntentPost201Response>> apiV1MediaUploadIntentPost({ 
    required ApiV1MediaUploadIntentPostRequest apiV1MediaUploadIntentPostRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/media/upload-intent';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(ApiV1MediaUploadIntentPostRequest);
      _bodyData = _serializers.serialize(apiV1MediaUploadIntentPostRequest, specifiedType: _type);
    ...
    ApiV1MediaUploadIntentPost201Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ApiV1MediaUploadIntentPost201Response),
      ) as ApiV1MediaUploadIntentPost201Response;
