...
class PaymentsApi {
  ...
  Future<Response<PaymentInitiateResponse>> apiV1PaymentsDepositsInitiatePost({ 
    required PaymentInitiateInput paymentInitiateInput,
    ...
    final _path = r'/api/v1/payments/deposits/initiate';
    ...
    try {
      const _type = FullType(PaymentInitiateInput);
      _bodyData = _serializers.serialize(paymentInitiateInput, specifiedType: _type);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PaymentStatusResponse>> apiV1PaymentsPaymentIdGet({ 
    ...
    final _path = r'/api/v1/payments/{paymentId}'.replaceAll('{' r'paymentId' '}', encodeQueryParameter(_serializers, paymentId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    PaymentStatusResponse? _responseData;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PaymentReconcileResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PaymentReconcileResponse>> apiV1PaymentsPaymentIdReconcilePost({ 
    required String paymentId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/payments/{paymentId}/reconcile'.replaceAll('{' r'paymentId' '}', encodeQueryParameter(_serializers, paymentId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    PaymentReconcileResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PaymentReconcileResponse),
      ) as PaymentReconcileResponse;
    ...
    return Response<PaymentReconcileResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [PaymentStatusResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PaymentStatusResponse>> apiV1PaymentsPaymentIdRefundPost({ 
    required String paymentId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/payments/{paymentId}/refund'.replaceAll('{' r'paymentId' '}', encodeQueryParameter(_serializers, paymentId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<ApiV1PaymentsWebhooksIntechPost200Response>> apiV1PaymentsWebhooksIntechPost({ 
    ...
    final _path = r'/api/v1/payments/webhooks/intech';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [ApiV1PaymentsWebhooksIntechPost200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiV1PaymentsWebhooksIntechPost200Response>> apiV1PaymentsWebhooksPaytechPost({ 
    required PaymentWebhookBody paymentWebhookBody,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/payments/webhooks/paytech';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
