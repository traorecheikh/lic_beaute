...
abstract final class AppColors {
  ...
  static const List<Color> staffTones = [
    Color(0xFFFFECF2), Color(0xFFEDF4FF), Color(0xFFEDF9F2),
    Color(0xFFFFFAED), Color(0xFFF3EEFF), Color(0xFFE8FAFD),
    Color(0xFFFFF0EC), Color(0xFFF0EBFF),
  ];

  // ── Gradient helpers ──────────────────────────────────────────────────────
  static const List<Color> heroGradient = [
    Color(0x00000000), Color(0x66000000), Color(0xCC000000),
  ];
  static const List<Color> splashGradient = [
    Color(0xFF1A1614), Color(0xFF2D1520),
  ];
}
